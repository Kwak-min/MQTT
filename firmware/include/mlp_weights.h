 ...
 *   → ml_model/README.md의 절차로 데이터를 수집하고 ml_model/train.py를 실행하세요.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
// 임시값에서는 기압과 가스비율의 가중치가 0이라 결과에 영향을 주지 않습니다 (기존 3입력 동작과 동일).
...
static const float MLP_W_HIDDEN[5][5] = {
  {  0.45f, -0.21f, -0.78f, 0.0f, 0.0f },
  { -0.12f,  0.34f, -0.62f, 0.0f, 0.0f },
  {  0.67f,  0.11f, -0.15f, 0.0f, 0.0f },
  { -0.29f, -0.55f, -0.91f, 0.0f, 0.0f },
  {  0.51f,  0.22f, -0.44f, 0.0f, 0.0f },
};
