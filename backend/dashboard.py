...
with col1:
    ...
    telemetry_path = os.path.join("logs", "telemetry.csv")
    if not os.path.exists(telemetry_path):
        telemetry_path = "telemetry.csv" # 백엔드 루트 또는 부모 디렉토리 대응
...
with col2:
    ...
    power_path = os.path.join("logs", "power.csv")
